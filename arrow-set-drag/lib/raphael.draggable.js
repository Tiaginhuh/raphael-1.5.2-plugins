 ...
 *
 *
 * Please note four extra lines of code have been added by @author top-flight
 * Search for paper.draggable.isArrowHead and paper.draggable.radius to see the changes made
 * 
 * For the original library visit: https://github.com/mephraim/raphael.draggable
 */
(function() {  
  /** 
  ...
  Raphael.fn.draggable.enable = function() {
    ...
    paper.draggable.isArrowHead = null;
    paper.draggable.radius = null;
  ...
  var DraggableExtension = function (element) {
    ...
    function _mouseDown(event) {
      ...
      _lastDragX = event.clientX;
      _lastDragY = event.clientY;
      paper.draggable.isArrowHead = (element.isArrowHead) ? true : false;
      paper.draggable.radius = (element.radius) ? element.radius : null;
    }
