...
(function() {  
  ...
  Raphael.fn.draggable.enable = function() {
    ...
    paper.draggable.customdragid = false;
    ...
    bindEvent("mousemove", _mouseMove, false);
    bindEvent("mouseup", _mouseUp, false);
    
    /**
     * Function to bind events, created as a work around for Internet Explorer
     *
     ...
     **/
    function bindEvent(eventType, listener, useCapture) {
  ...
  var DraggableExtension = function (element) {
    ...
    function _mouseDown(event) {
      ...
      _lastDragX = event.clientX;
      _lastDragY = event.clientY;
      paper.draggable.customdragid = (element.attr("customdragid")) ? element.attr("customdragid") : false;
    }
